...
from lib.data import fold_n_files
...
def n_files_test(run_name, dataset_name, create_model, unpack, pack, create_folding, name_list):
    """
    Simple test.
        This model is general example of how you can use :func:``fold_n_files`` 
