...
from lib.data import fold_10euqal
...
def manyfolds_test(run_name, dataset_name, create_model, unpack, pack, create_folding, name_list):
    """
    Simple test.
        This model is general example of how you can use :func:``fold_10euqal`` 
...
def main():
    ...
    for i, fold_method in enumerate([fold_10euqal]):# loop for folding metheds
